...
import com.newbee.mall.controller.vo.SecondLevelCategoryVO;
import com.newbee.mall.controller.vo.ThirdLevelCategoryVO;
import com.newbee.mall.dao.GoodsCategoryMapper;
...
public class NewBeeMallCategoryServiceImpl implements NewBeeMallCategoryService {
    ...
    public List<NewBeeMallIndexCategoryVO> getCategoriesForIndex() {
        ...
        //获取一级分类的固定数量的数据
        List<GoodsCategory> firstLevelCategories = goodsCategoryMapper.selectByLevelAndParentIdsAndNumber(Collections.singletonList(0L), MallCategoryLevelEnum.LEVEL_ONE.getLevel(), Constants.HOME_CATEGORY_AMOUNT);
    ...
    public SearchPageCategoryVO getCategoriesForSearch(Long categoryId) {
        ...
        if (thirdLevelGoodsCategory != null && thirdLevelGoodsCategory.getCategoryLevel() == MallCategoryLevelEnum.LEVEL_THREE.getLevel()) {
            ...
            if (secondLevelGoodsCategory != null && secondLevelGoodsCategory.getCategoryLevel() == MallCategoryLevelEnum.LEVEL_TWO.getLevel()) {
                //获取当前二级分类下的三级分类List
                List<GoodsCategory> thirdLevelCategories = goodsCategoryMapper.selectByLevelAndParentIdsAndNumber(Collections.singletonList(secondLevelGoodsCategory.getCategoryId()), MallCategoryLevelEnum.LEVEL_THREE.getLevel(), Constants.SEARCH_CATEGORY_AMOUNT);
