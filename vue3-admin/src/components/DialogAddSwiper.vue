<template>
    <el-dialog
            ...
            width="400px"
    >
        <el-form :model="ruleForm" :rules="rules" class="good-form" label-width="100px" ref="formRef">
            ...
            token: token
                ...
                >
                    <img :src="ruleForm.url" class="avatar"
                         style="width: 200px; height: 100px; border: 1px solid #e9e9e9;" v-if="ruleForm.url">
