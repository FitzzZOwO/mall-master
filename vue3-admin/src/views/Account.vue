<template>
    <el-card class="account-container">
        <el-form :model="nameForm" :rules="rules" class="demo-ruleForm" label-position="right" label-width="80px"
                 ref="nameRef">
            ...
            <el-form-item>
                <el-button @click="submitName" type="danger">确认修改</el-button>
            </el-form-item>
        </el-form>
    </el-card>
    <el-card class="account-container">
        <el-form :model="passForm" :rules="rules" class="demo-ruleForm" label-position="right" label-width="80px"
                 ref="passRef">
            ...
            <el-form-item>
                <el-button @click="submitPass" type="danger">确认修改</el-button>
            </el-form-item>
        </el-form>
    </el-card>
</template>
