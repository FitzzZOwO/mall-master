<template>
    <div class="add">
        <el-card class="add-container">
            <el-form :model="goodForm" :rules="rules" class="goodForm" label-width="100px" ref="goodRef">
                <el-form-item label="商品分类" required>
                    <el-cascader :placeholder="defaultCate" :props="category" @change="handleChangeCate"
                                 style="width: 300px"></el-cascader>
                </el-form-item>
                <el-form-item label="商品名称" prop="goodsName">
                    <el-input placeholder="请输入商品名称" style="width: 300px" v-model="goodForm.goodsName"></el-input>
                </el-form-item>
                <el-form-item label="商品简介" prop="goodsIntro">
                    <el-input placeholder="请输入商品简介(100字)" style="width: 300px" type="textarea"
                              v-model="goodForm.goodsIntro"></el-input>
                </el-form-item>
                <el-form-item label="商品价格" prop="originalPrice">
                    <el-input min="0" placeholder="请输入商品价格" style="width: 300px" type="number"
                              v-model="goodForm.originalPrice"></el-input>
                </el-form-item>
                <el-form-item label="商品售卖价" prop="sellingPrice">
                    <el-input min="0" placeholder="请输入商品售价" style="width: 300px" type="number"
                              v-model="goodForm.sellingPrice"></el-input>
                </el-form-item>
                <el-form-item label="商品库存" prop="stockNum">
                    <el-input min="0" placeholder="请输入商品库存" style="width: 300px" type="number"
                              v-model="goodForm.stockNum"></el-input>
                </el-form-item>
                <el-form-item label="商品标签" prop="tag">
                    <el-input placeholder="请输入商品小标签" style="width: 300px" v-model="goodForm.tag"></el-input>
                </el-form-item>
                ...
                <el-form-item label="商品主图" prop="goodsCoverImg" required>
                    <el-upload
              ...
              token: token
                    ...
                    >
                        <img :src="goodForm.goodsCoverImg" class="avatar"
                ...
                <el-form-item>
                    <el-button @click="submitAdd()" type="primary">{{ id ? '立即修改' : '立即创建' }}</el-button>
                </el-form-item>
            </el-form>
        </el-card>
    </div>
