...
CREATE TABLE `tb_newbee_mall_carousel` (
  `carousel_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '首页banner图主键id',
  `carousel_url` varchar(100) NOT NULL DEFAULT '' COMMENT 'banner图',
...
CREATE TABLE `tb_newbee_mall_goods_info` (
  ...
  `goods_carousel` varchar(500) NOT NULL DEFAULT '/admin/dist/img/no-img.png' COMMENT '商品banner图',
