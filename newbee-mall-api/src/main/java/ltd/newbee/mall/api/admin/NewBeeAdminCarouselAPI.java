 ...
 */
@RestController
@Api(value = "v1", tags = "8-1.后台管理系统banner图模块接口")
...
public class NewBeeAdminCarouselAPI {
    ...
    @ApiOperation(value = "banner图列表", notes = "banner图列表")
    ...
    @ApiOperation(value = "新增banner图", notes = "新增banner图")
    ...
    @ApiOperation(value = "修改banner图信息", notes = "修改banner图信息")
    ...
    @ApiOperation(value = "获取单条banner图信息", notes = "根据id查询")
    ...
    @ApiOperation(value = "批量删除banner图信息", notes = "批量删除banner图信息")
