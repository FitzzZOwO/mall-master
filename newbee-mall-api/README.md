...
newbee-mall 项目是一套电商系统，基于 Spring Boot 2.X 和 Vue 以及相关技术栈开发。前台商城系统包含首页门户、商品分类、新品上线、首页banner、商品推荐、商品搜索、商品展示、购物车、订单结算、订单流程、个人订单管理、会员中心、帮助中心等模块。 后台管理系统包含数据面板、banner图管理、商品管理、订单管理、会员管理、分类管理、设置等模块。
...
- [API 接口开发实战之banner图管理模块接口开发](https://juejin.cn/book/6933939264455442444)
...
- [商城移动端开发实战-商城首页制作(banner图、首页商品列表)](https://juejin.im/book/6844733826191589390)
