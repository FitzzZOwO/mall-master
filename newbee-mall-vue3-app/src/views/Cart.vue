  ...
  <div class="cart-box">
    ...
    <div class="cart-body">
      <van-checkbox-group @change="groupChange" ref="checkboxGroup" v-model="result">
        <van-swipe-cell :key="index" :right-width="50" v-for="(item, index) in list">
          <div class="good-item">
    ...
    <div class="empty" v-if="!list.length">
      <img alt="空购物车" class="empty-cart" src="https://s.yezgea02.com/1604028375097/empty-car.png">
      <div class="title">购物车空空如也</div>
      <van-button @click="goTo" block color="#1baeae" round type="primary">前往选购</van-button>
    </div>
    <nav-bar></nav-bar>
  </div>
</template>
