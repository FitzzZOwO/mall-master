...
<template>
  <div class="create-order">
    ...
    <div class="good">
      <div :key="index" class="good-item" v-for="(item, index) in cartList">
    ...
    <div class="pay-wrap">
      ...
      <van-button @click="handleCreateOrder" block class="pay-btn" color="#1baeae" type="primary">生成订单</van-button>
    </div>
    <van-popup
    ...
    >
      <div :style="{ width: '90%', margin: '0 auto', padding: '50px 0' }">
        <van-button :style="{ marginBottom: '10px' }" @click="handlePayOrder(1)" block color="#1989fa">支付宝支付
        </van-button>
        <van-button @click="handlePayOrder(2)" block color="#4fc08d">微信支付</van-button>
      </div>
    </van-popup>
  </div>
</template>
