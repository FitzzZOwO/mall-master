...
<template>
  <div class="seting-box">
    ...
    <div class="input-item">
      ...
      <van-field label="修改密码" type='password' v-model="password"/>
    </div>
    <van-button @click="save" block class="save-btn" color="#1baeae" round type="primary">保存</van-button>
    <van-button @click="handleLogout" block class="save-btn" color="#1baeae" round type="primary">退出登录</van-button>
  </div>
</template>
