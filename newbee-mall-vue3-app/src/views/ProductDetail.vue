...
<template>
  <div class="product-detail">
    ...
    <div class="detail-content">
      <div class="detail-swipe-wrap">
        <van-swipe class="my-swipe" indicator-color="#1baeae">
          <van-swipe-item :key="index" v-for="(item, index) in detail.goodsCarouselList">
            <img :src="item" alt="">
          </van-swipe-item>
        </van-swipe>
      </div>
    ...
    <van-action-bar>
      ...
      <van-action-bar-icon :badge="!count ? '' : count" @click="goTo()" icon="cart-o" text="购物车"/>
      <van-action-bar-button @click="handleAddCart" text="加入购物车" type="warning"/>
      <van-action-bar-button @click="goToCart" text="立即购买" type="danger"/>
    </van-action-bar>
  </div>
</template>
