    ...
    <div class="categray">
        <div>
            <header class="category-header wrap van-hairline--bottom">
                <i @click="goHome" class="nbicon nbfanhui"></i>
